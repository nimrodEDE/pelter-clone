    ...
    <article className="aboutSection">
      ...
      <section className="colomns">
        <div style={{ order: 2 }} className="colomns-img">
          <img
            src="/pelter-clone/images/about-img1.jpg"
      ...
      <img
        ...
        src="/pelter-clone/images/sliding-picture-1.jpg"
        alt="sliding-picture-1"
      />
      <section className="colomns">
        <div className="colomns-img VC">
          <img
            src="/pelter-clone/images/about-img2.jpg"
            alt="Wine Bottles on the ground"
          />
        </div>
      ...
      <img
        className="slidingImg"
        src="/pelter-clone/images/sliding-picture-2.jpg"
      ...
      <section className="colomns">
        ...
        >
          <img
            src="/pelter-clone/images/about-img3.jpg"
            alt="Wine Bottles on the ground"
          />
        </div>
